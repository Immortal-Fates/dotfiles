...
TRACKER INTEGRATION
- Session-start tracker registration runs automatically when tmux context is available.
- Only call `tracker_mark_start_working` manually if the automatic start marker did not appear and you need to begin tracking for the current pane.
